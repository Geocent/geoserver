 ...
 * 
 */
public abstract class GeoXACMLFunctionBase extends AbstractFunction {
    ...
    public GeoXACMLFunctionBase(String functionId) {
    ...
    abstract protected Object evaluate(Object ... objects) throws FunctionProcessingException;
